            ...
            <section class="content-inner">
                ...
                <section class="content">
                    ...
                    <jsp:include page="highlight.jsp">
                        <jsp:param name="header" value="Prosecution Request Evidence" />
                    </jsp:include>
                    ...
                    <section class="content-box">
                        ...
                        <section class="dynamic-content" data-template-url="assets/ajax/table/table-v4/table-v4.html" data-json-url="/tpcmsWebAdmin/api/prosecution/cases/evidence"></section>
                    </section>
