            ...
            <section class="content-inner">
                ...
                <section class="content">
                    ...
                    <jsp:include page="highlight_back_to_overview.jsp">
                        <jsp:param name="header" value="Update Mission Card"/>
                        <jsp:param name="redirect" value="missionPermitsView"/>
                        <jsp:param name="pageName" value="Mission Permits"/>
                        <jsp:param name="httpError" value="${httpError}"/>
                    </jsp:include>

                    <form:form id="update-misison-card-form" modelAttribute="updateMissionPermit" method="post">
