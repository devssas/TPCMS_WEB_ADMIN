                ...
                <section class="content">
                    ...
                    <section class="content-box">
                        <section class="site-data-container"
                                 data-template-url="assets/ajax/table/calendar/calendar.html"
                                 data-json-url="/tpcmsWebAdmin/api/calendarEvent?calendarDate=${calendarDate}">
                            <div class="icon-content-box">
                                <ul>
                                    <li><a href="javascript:;" data-fancybox-card data-type='ajax'
                                           data-src='/tpcmsWebAdmin/card/calenderNew'><i class="icon-calender"></i></a>
                                    </li>
                                </ul>
                            </div>
