            ...
            <section class="content-inner">
                ...
                <section class="content">
                    ...
                    <jsp:include page="highlight.jsp">
                        <jsp:param name="header" value="Manage Permits" />
                    </jsp:include>
                            ...
                            <form action="">
                                <div class="form-container">
                                    ...
                                    <div class="table-filter-inner">
                                        ...
                                        <a href="${pageContext.request.contextPath}/missionPermitsMenu" class="button button-v3 fix-size-sml right-fix">Back to Overview</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <section class="dynamic-content" data-template-url="assets/ajax/table/table-v7/table-v7.html" data-json-url="/tpcmsWebAdmin/api/missionPermits"></section>
                    </section>
