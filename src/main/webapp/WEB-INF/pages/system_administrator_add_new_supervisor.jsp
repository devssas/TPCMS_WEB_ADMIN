            ...
            <section class="content-inner">
                ...
                <section class="content">
                    ...
                    <jsp:include page="highlight_back_to_overview.jsp">
                        <jsp:param name="header" value="Add New Supervisor" />
                    ...
                    <form:form id="new-supervisor" modelAttribute="newSupervisor" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-container">
                                                ...
                                                <div class="form-row">
                                                    <label>
                                                        ...
                                                        <form:input id="officerId" path="officerId" placeholder="Only numbers"/>
                                                    </label>
                                                </div>
                                            </div> <!-- form-container -->
                                        </div> <!-- inner -->
                                            ...
                                            <div class="form-container">
                                                <div class="form-row">
                                                    <label>
                                                        ...
                                                        <form:input id="userCode" path="userCode" maxlength="5" disabled="true"/>
                                                    </label>
                                                </div>
                                                <div class="form-row">
                                                    <label>
                                                        <span class="label">PassCode *</span>
                                                        <form:input id="passCode" path="passCode" maxlength="3" disabled="true"/>
                                                    </label>
                                                </div>
                                                <div class="form-row select-not-find">
                                                    <label>
                                                        <span class="label">Reporting Officer Id *</span>
                                                        <form:input id="reportingOfficer" path="reportingOfficer" placeholder="Only numbers"/>
                                                    </label>
                                                </div>
                                            </div> <!-- form-container -->
                                        </div> <!-- inner -->
                                            ...
                                            <div class="form-container">
                                                <div class="form-row">
                                                    <label>
                                                        ...
                                                        <form:input id="location" path="location" placeholder="Location..."/>
                                                    </label>
                                                </div>
                                                <div class="form-row">
                                                    <label>
                                            ...
                                            <div class="form-container">
                                                ...
                                                <div class="form-row phone-number-row">
                                                    <label>
                                                        ...
                                                        <span class="phone-number-content">
                                                            <form:input id="emergencyContactCountryCode" class="emergencyContactCountryCode" path="emergencyContactCountryCode" placeholder="+218"/>
                                                            <form:input id="emergencyContactNumber" class="emergencyContactNumber" path="emergencyContactNumber" placeholder="1234567890"/>
                                                      </span>
                                                    </label>
                                                </div>
                                                <div class="form-row">
