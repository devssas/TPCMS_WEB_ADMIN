            ...
            <div class="inner">
                ...
                <nav class="menu">
                    <ul>
                        ...
                        <li style="${param.disabled}"><a href="${pageContext.request.contextPath}/prosecutionOfficeMenu" class="${param.prosecutionOffice}"><i class="icon-prosecution-office"></i>Prosecution Office</a></li>
