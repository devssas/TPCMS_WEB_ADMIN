            ...
            <section class="content-inner">
                ...
                <section class="content">
                    ...
                    <c:choose>
                        <c:when test="${accessRole=='PROSECUTION'}">
                            <jsp:include page="highlight_back_to_overview.jsp">
                                <jsp:param name="header" value="Cases History"/>
                    ...
                    <section class="content-box">
                        ...
                        <section class="site-data-container" data-template-url="assets/ajax/table/table-v3/table-v3.html" data-json-url="/tpcmsWebAdmin/api/prosecution/casesHistory">
                                    ...
                                    <div class="form-container">
                                        <div class="search-box">
                                            ...
                                            <div class="form-row submit-row">
                                                <button type="submit"
                                                        class="button button-v3 button-icons fix-size-sml">Search <i
                                        ...
                                        <div class="table-filter-inner">
                                            ...
                                            <a href="${pageContext.request.contextPath}/"${redirect}" class="button
                                            button-v3 fix-size-sml right-fix">Back to Overview</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
