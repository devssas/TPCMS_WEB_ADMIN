...
import com.tpcmswebadmin.webpages.prosecutionoffice.delegate.ProsecutionCasesHistoryDelegate;
...
public class ProsecutionCasesHistory {
    ...
    private final ProsecutionCasesHistoryDelegate prosecutionCasesHistoryDelegate;
    ...
    public String getProsecutionOffice(Model model, HttpServletRequest httpServletRequest) {
        ...
        model.addAttribute("statuses", prosecutionCasesHistoryDelegate.getCriminalCaseStatuses(httpServletRequest));
